...
contract SoulboundProfileNFT is ERC721, Ownable {
    ...
    // q what happens if the user has has liked n profiles?
    // or has a match before burning the profile? - do matched users lose the money in the multisig pool?
    //  - funds refunded or retained in the contract?
